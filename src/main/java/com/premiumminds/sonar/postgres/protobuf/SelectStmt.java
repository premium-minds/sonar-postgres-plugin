...
private static final long serialVersionUID = 0L;
  ...
  private SelectStmt(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  private SelectStmt() {
  ...
  private int computeSerializedSize_0() {
    ...
    if (((bitField0_ & 0x00000001) != 0)) {
      size += com.google.protobuf.CodedOutputStream
        ...
        {
          final int count = fromClause_.size();
          for (int i = 0; i < count; i++) {
            size += com.google.protobuf.CodedOutputStream
              .computeMessageSizeNoTag(fromClause_.get(i));
          }
          size += 1 * count;
        }
    if (((bitField0_ & 0x00000002) != 0)) {
    ...
    if (limitOption_ != com.premiumminds.sonar.postgres.protobuf.LimitOption.LIMIT_OPTION_UNDEFINED.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
        ...
        {
          final int count = lockingClause_.size();
          for (int i = 0; i < count; i++) {
            size += com.google.protobuf.CodedOutputStream
              .computeMessageSizeNoTag(lockingClause_.get(i));
          }
          size += 1 * count;
        }
    if (((bitField0_ & 0x00000020) != 0)) {
  ...
  public static final class Builder extends
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage
        ...
        internalGetIntoClauseFieldBuilder();
        internalGetTargetListFieldBuilder();
        internalGetFromClauseFieldBuilder();
        internalGetWhereClauseFieldBuilder();
        internalGetGroupClauseFieldBuilder();
        internalGetHavingClauseFieldBuilder();
        ...
        internalGetLockingClauseFieldBuilder();
        internalGetWithClauseFieldBuilder();
        internalGetLargFieldBuilder();
        internalGetRargFieldBuilder();
      }
    }
    @java.lang.Override
      ...
      if (fromClauseBuilder_ == null) {
        ...
        if (!other.fromClause_.isEmpty()) {
          if (fromClauseBuilder_.isEmpty()) {
            ...
            fromClauseBuilder_ = 
              com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                 internalGetFromClauseFieldBuilder() : null;
          } else {
        ...
        if (!other.lockingClause_.isEmpty()) {
          if (lockingClauseBuilder_.isEmpty()) {
            ...
            lockingClauseBuilder_ = 
              com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                 internalGetLockingClauseFieldBuilder() : null;
          } else {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              input.readMessage(
                  internalGetIntoClauseFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 66: {
              input.readMessage(
                  internalGetHavingClauseFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 154: {
              input.readMessage(
                  internalGetLargFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 162: {
              input.readMessage(
                  internalGetRargFieldBuilder().getBuilder(),
                  extensionRegistry);
    ...
    public com.premiumminds.sonar.postgres.protobuf.IntoClause.Builder getIntoClauseBuilder() {
      bitField0_ |= 0x00000002;
      onChanged();
      return internalGetIntoClauseFieldBuilder().getBuilder();
    }
    /**
     * <code>.pg_query.IntoClause into_clause = 2 [json_name = "intoClause"];</code>
     */
    ...
    private com.google.protobuf.SingleFieldBuilder<
        ...
        internalGetIntoClauseFieldBuilder() {
      if (intoClauseBuilder_ == null) {
        intoClauseBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            com.premiumminds.sonar.postgres.protobuf.IntoClause, com.premiumminds.sonar.postgres.protobuf.IntoClause.Builder, com.premiumminds.sonar.postgres.protobuf.IntoClauseOrBuilder>(
                getIntoClause(),
                getParentForChildren(),
                isClean());
    ...
    public com.premiumminds.sonar.postgres.protobuf.Node.Builder getFromClauseBuilder(
        int index) {
      return internalGetFromClauseFieldBuilder().getBuilder(index);
    }
    /**
     * <code>repeated .pg_query.Node from_clause = 4 [json_name = "fromClause"];</code>
     */
    ...
    public com.premiumminds.sonar.postgres.protobuf.Node.Builder addFromClauseBuilder() {
      return internalGetFromClauseFieldBuilder().addBuilder(
          com.premiumminds.sonar.postgres.protobuf.Node.getDefaultInstance());
    }
    /**
     * <code>repeated .pg_query.Node from_clause = 4 [json_name = "fromClause"];</code>
    ...
    public java.util.List<com.premiumminds.sonar.postgres.protobuf.Node.Builder> 
      ...
      return internalGetFromClauseFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilder<
        com.premiumminds.sonar.postgres.protobuf.Node, com.premiumminds.sonar.postgres.protobuf.Node.Builder, com.premiumminds.sonar.postgres.protobuf.NodeOrBuilder> 
        internalGetFromClauseFieldBuilder() {
      if (fromClauseBuilder_ == null) {
        fromClauseBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
            com.premiumminds.sonar.postgres.protobuf.Node, com.premiumminds.sonar.postgres.protobuf.Node.Builder, com.premiumminds.sonar.postgres.protobuf.NodeOrBuilder>(
                fromClause_,
    ...
    public com.premiumminds.sonar.postgres.protobuf.Node.Builder getHavingClauseBuilder() {
      bitField0_ |= 0x00000080;
      onChanged();
      return internalGetHavingClauseFieldBuilder().getBuilder();
    }
    /**
     * <code>.pg_query.Node having_clause = 8 [json_name = "havingClause"];</code>
     */
    ...
    private com.google.protobuf.SingleFieldBuilder<
        ...
        internalGetHavingClauseFieldBuilder() {
      if (havingClauseBuilder_ == null) {
        havingClauseBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            com.premiumminds.sonar.postgres.protobuf.Node, com.premiumminds.sonar.postgres.protobuf.Node.Builder, com.premiumminds.sonar.postgres.protobuf.NodeOrBuilder>(
                getHavingClause(),
                getParentForChildren(),
                isClean());
    ...
    public com.premiumminds.sonar.postgres.protobuf.Node.Builder getLockingClauseBuilder(
        int index) {
      return internalGetLockingClauseFieldBuilder().getBuilder(index);
    }
    /**
     * <code>repeated .pg_query.Node locking_clause = 15 [json_name = "lockingClause"];</code>
     */
    ...
    public com.premiumminds.sonar.postgres.protobuf.Node.Builder addLockingClauseBuilder() {
      return internalGetLockingClauseFieldBuilder().addBuilder(
          com.premiumminds.sonar.postgres.protobuf.Node.getDefaultInstance());
    }
    /**
     * <code>repeated .pg_query.Node locking_clause = 15 [json_name = "lockingClause"];</code>
    ...
    public java.util.List<com.premiumminds.sonar.postgres.protobuf.Node.Builder> 
      ...
      return internalGetLockingClauseFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilder<
        com.premiumminds.sonar.postgres.protobuf.Node, com.premiumminds.sonar.postgres.protobuf.Node.Builder, com.premiumminds.sonar.postgres.protobuf.NodeOrBuilder> 
        internalGetLockingClauseFieldBuilder() {
      if (lockingClauseBuilder_ == null) {
        lockingClauseBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
            com.premiumminds.sonar.postgres.protobuf.Node, com.premiumminds.sonar.postgres.protobuf.Node.Builder, com.premiumminds.sonar.postgres.protobuf.NodeOrBuilder>(
                lockingClause_,
    ...
    public com.premiumminds.sonar.postgres.protobuf.SelectStmt.Builder getLargBuilder() {
      bitField0_ |= 0x00040000;
      onChanged();
      return internalGetLargFieldBuilder().getBuilder();
    }
    /**
     * <code>.pg_query.SelectStmt larg = 19 [json_name = "larg"];</code>
     */
    ...
    private com.google.protobuf.SingleFieldBuilder<
        ...
        internalGetLargFieldBuilder() {
      if (largBuilder_ == null) {
        largBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            com.premiumminds.sonar.postgres.protobuf.SelectStmt, com.premiumminds.sonar.postgres.protobuf.SelectStmt.Builder, com.premiumminds.sonar.postgres.protobuf.SelectStmtOrBuilder>(
                getLarg(),
                getParentForChildren(),
                isClean());
    ...
    public com.premiumminds.sonar.postgres.protobuf.SelectStmt.Builder getRargBuilder() {
      bitField0_ |= 0x00080000;
      onChanged();
      return internalGetRargFieldBuilder().getBuilder();
    }
    /**
     * <code>.pg_query.SelectStmt rarg = 20 [json_name = "rarg"];</code>
     */
    ...
    private com.google.protobuf.SingleFieldBuilder<
        ...
        internalGetRargFieldBuilder() {
      if (rargBuilder_ == null) {
        rargBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            com.premiumminds.sonar.postgres.protobuf.SelectStmt, com.premiumminds.sonar.postgres.protobuf.SelectStmt.Builder, com.premiumminds.sonar.postgres.protobuf.SelectStmtOrBuilder>(
                getRarg(),
                getParentForChildren(),
                isClean());
