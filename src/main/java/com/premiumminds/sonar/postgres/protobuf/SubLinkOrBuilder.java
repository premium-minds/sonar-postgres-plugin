...
public interface SubLinkOrBuilder extends
   ...
   * <code>repeated .pg_query.Node oper_name = 5 [json_name = "operName"];</code>
   */
  com.premiumminds.sonar.postgres.protobuf.Node getOperName(int index);
  /**
   * <code>repeated .pg_query.Node oper_name = 5 [json_name = "operName"];</code>
   */
   ...
   * <code>repeated .pg_query.Node oper_name = 5 [json_name = "operName"];</code>
   */
  com.premiumminds.sonar.postgres.protobuf.NodeOrBuilder getOperNameOrBuilder(
      int index);
   ...
   */
  com.premiumminds.sonar.postgres.protobuf.Node getSubselect();
  /**
   * <code>.pg_query.Node subselect = 6 [json_name = "subselect"];</code>
   */
  com.premiumminds.sonar.postgres.protobuf.NodeOrBuilder getSubselectOrBuilder();
