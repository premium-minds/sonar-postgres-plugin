...
private static final long serialVersionUID = 0L;
  ...
  private ReturnStmt(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  private ReturnStmt() {
  }
  ...
  public static final class Builder extends
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage
        ...
        internalGetReturnvalFieldBuilder();
      }
    }
    @java.lang.Override
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.readMessage(
                  internalGetReturnvalFieldBuilder().getBuilder(),
                  extensionRegistry);
    ...
    public com.premiumminds.sonar.postgres.protobuf.Node.Builder getReturnvalBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
      return internalGetReturnvalFieldBuilder().getBuilder();
    }
    /**
     * <code>.pg_query.Node returnval = 1 [json_name = "returnval"];</code>
     */
