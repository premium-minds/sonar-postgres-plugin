...
private static final long serialVersionUID = 0L;
  ...
  private AlternativeSubPlan(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  private int computeSerializedSize_0() {
    ...
    if (((bitField0_ & 0x00000001) != 0)) {
      size += com.google.protobuf.CodedOutputStream
        ...
        {
          final int count = subplans_.size();
          for (int i = 0; i < count; i++) {
            size += com.google.protobuf.CodedOutputStream
              .computeMessageSizeNoTag(subplans_.get(i));
          }
          size += 1 * count;
        }
    return size;
  ...
  public static final class Builder extends
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage
        ...
        internalGetSubplansFieldBuilder();
      }
    }
    @java.lang.Override
          ...
          if (subplansBuilder_.isEmpty()) {
            ...
            subplansBuilder_ = 
              com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                 internalGetSubplansFieldBuilder() : null;
          } else {
    ...
    public com.premiumminds.sonar.postgres.protobuf.Node.Builder getSubplansBuilder(
        int index) {
      return internalGetSubplansFieldBuilder().getBuilder(index);
    }
    /**
     * <code>repeated .pg_query.Node subplans = 2 [json_name = "subplans"];</code>
     */
    ...
    public com.premiumminds.sonar.postgres.protobuf.Node.Builder addSubplansBuilder() {
      return internalGetSubplansFieldBuilder().addBuilder(
    ...
    public java.util.List<com.premiumminds.sonar.postgres.protobuf.Node.Builder> 
      ...
      return internalGetSubplansFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilder<
        com.premiumminds.sonar.postgres.protobuf.Node, com.premiumminds.sonar.postgres.protobuf.Node.Builder, com.premiumminds.sonar.postgres.protobuf.NodeOrBuilder> 
        internalGetSubplansFieldBuilder() {
      if (subplansBuilder_ == null) {
        subplansBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
            com.premiumminds.sonar.postgres.protobuf.Node, com.premiumminds.sonar.postgres.protobuf.Node.Builder, com.premiumminds.sonar.postgres.protobuf.NodeOrBuilder>(
                subplans_,
